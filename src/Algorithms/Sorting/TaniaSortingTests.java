 ...
 * @version 1.0
 */
public class TaniaSortingTests {
    ...
    public void testSelectionSort() {
        ...
        assertTrue("Number of comparisons: " + comp.getCount(),
                comp.getCount() <= 55 && comp.getCount() != 0);
    }
    ...
    @Test(timeout = TIMEOUT)
    public void testLsdRadixSortNegativeNumbers() {
        int[] unsortedArray = new int[] {54, -28, 58, -84, 20, -122, 85, 3};
        int[] sortedArray = new int[] {-122, -84, -28, 3, 20, 54, 58, 85};
        Sorting.lsdRadixSort(unsortedArray);
        assertArrayEquals(sortedArray, unsortedArray);
    }

    @Test(timeout = TIMEOUT)
    public void testLsdRadixSortMinAndMaxInteger() {
        int[] unsortedArray = new int[] {54, -28, 58, -84, Integer.MAX_VALUE, 20, -122, Integer.MIN_VALUE, 85, 3 };
        int[] sortedArray = new int[]   {Integer.MIN_VALUE, -122, -84, -28, 3, 20, 54, 58, 85, Integer.MAX_VALUE};
        Sorting.lsdRadixSort(unsortedArray);
        assertArrayEquals(sortedArray, unsortedArray);
    }
    /**
    ...
    private static class TeachingAssistant {
        ...
        public static ComparatorPlus<TeachingAssistant> getNameComparator() {
            return new ComparatorPlus<TaniaSortingTests.TeachingAssistant>() {
                @Override
                public int compare(TaniaSortingTests.TeachingAssistant ta1,
                                   TaniaSortingTests.TeachingAssistant ta2) {
                    incrementCount();
