...
public class HeapPQStudentTestsImproved {
    ...
    public void testBuildHeapThrowsIllegalArgumentIfArrayListIsNull() {
        System.out.println("\nChecking if DataStructures.tree.maxheap.MaxHeap(ArrayList<T>) throws IllegalArgumentException when ArrayList is null...");
    ...
    public void testBuildHeapThrowsIllegalArgumentIfDataIsNull() {
        System.out.println("\nChecking if DataStructures.tree.maxheap.MaxHeap(ArrayList<T> throws IllegalArgumentException when data is null...");
