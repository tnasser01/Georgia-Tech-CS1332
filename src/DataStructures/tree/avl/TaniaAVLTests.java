...
/**
 * Tests for DataStructures.tree.avl.AVL Tree
 *
 * @author Tania
 * @version 1
 */
public class TaniaAVLTests {
    ...
    public void testRemoveElementNotInTree() {
        AVLInterface<Integer> avl = new AVL<>();
 ...
 */
    ...
    public void testRemoveNoChildren() {
        ...
        assertEquals(2, avl.getRoot().getRight().getLeft().getData()
                .intValue());
        assertEquals(6, avl.getRoot().getRight().getRight()
                .getData().intValue());
        assertEquals(7, avl.getRoot().getRight().getRight().getRight()
                .getData().intValue());
        assertEquals(5, avl.getRoot().getRight().getRight().getLeft()
                .getData().intValue());
        assertEquals(2, avl.remove(2).intValue());
        //The removal of 2 should cause left rotation
        assertEquals(12, avl.size());
        assertEquals(6, avl.getRoot().getRight().getData().intValue());
        assertEquals(4, avl.getRoot().getRight().getLeft().getData().intValue());
        assertEquals(5, avl.getRoot().getRight().getLeft().getRight()
                .getData().intValue());
        assertEquals(7, avl.getRoot().getRight().getRight().getData().intValue());
    }
...
*/
    ...
    public void testRemoveNodeWithOneLeftChild() {
        ...
        assertEquals(15, avl.size());
        assertEquals(-1, avl.remove(-1).intValue());
        assertEquals(-2, avl.getRoot().getLeft().getRight().getData().intValue());
        assertEquals(-2, avl.remove(-2).intValue());
        //When -2 is removed, it should be replaced by its left child -3
        assertEquals(-3, avl.getRoot().getLeft().getRight().getData().intValue());

        assertEquals(-4, avl.getRoot().getLeft().getData()
                .intValue());
        assertEquals(0, avl.getRoot()
                .getData().intValue());

        assertEquals(-3, avl.remove(-3).intValue());
        //The removal of -3 should cause a right rotation.
        assertEquals(12, avl.size());

        assertEquals(-6, avl.getRoot().getLeft().getData().intValue());
        assertEquals(-4, avl.getRoot().getLeft().getRight().getData()
                .intValue());
        assertEquals(-7, avl.getRoot().getLeft().getLeft()
                .getData().intValue());
        assertEquals(-5, avl.getRoot().getLeft().getRight().getLeft()
                .getData()
                .intValue());
    }
...
*/
    ...
    public void testRemoveNodeWithOneRightChild() {
        ...
        assertEquals(15, avl.size());
        assertEquals(1, avl.remove(1).intValue());
        assertEquals(2, avl.getRoot().getRight().getLeft().getData().intValue
                ());
        assertEquals(2, avl.remove(2).intValue());
        //When 2 is removed, it should be replaced by its left child 3
        assertEquals(3, avl.getRoot().getRight().getLeft().getData().intValue());
        ...
        assertEquals(6, avl.getRoot().getRight().getData().intValue());
        assertEquals(4, avl.getRoot().getRight().getLeft().getData()
                .intValue());
        assertEquals(7, avl.getRoot().getRight().getRight()
                .getData().intValue());
        assertEquals(5, avl.getRoot().getRight().getLeft().getRight()
                .getData()
                .intValue());
...
//    @Test(timeout = TIMEOUT)
//    public void testSecondLargestWithNoRightSubTree() {
//        DataStructures.tree.avl.AVLInterface<Integer> avl = new DataStructures.tree.avl.AVL<>();
//        avl.add(0);
//        avl.add(-4);
//        avl.add(-2);
//        avl.add(-6);
...
*/
    ...
    public void testRemoveNodeWithTwoChildren() {
        ...
        assertEquals(1, avl.remove(1).intValue());
        assertEquals(2, avl.remove(2).intValue());
        //The removal of 2 should cause a left rotation of 4
        ...
        assertEquals(7, avl.getRoot().getRight().getRight().getData()
                .intValue());
        assertEquals(4, avl.getRoot().getRight().getLeft()
                .getData().intValue());
        assertEquals(5, avl.getRoot().getRight().getLeft().getRight()
                .getData().intValue());
    }
    ...
    public void testRemove2Children() {
      ...
      //  assertEquals(6, avl.getSecondLargest().intValue());
       ...
       // assertEquals(6, avl.getSecondLargest().intValue());
        ...
        assertEquals(2, avl.remove(2).intValue()); //removing 2 causes a
        // left rotation
        assertEquals(3, avl.getRoot().getData().intValue());
        assertEquals(6, avl.getRoot().getRight().getData().intValue());
        assertEquals(7,
     ...
     //   assertEquals(6, avl.getSecondLargest().intValue());
      ...
      //  assertEquals(6, avl.getSecondLargest().intValue());
        ...
        //Removing 5 causes a right rotation on 6, the
        assertEquals(-4, avl.getRoot().getData().intValue());
        assertEquals(6, avl.getRoot().getRight().getData().intValue());
        assertEquals(7,
                avl.getRoot().getRight().getRight().getData().intValue());
  ...
  -7          -1    3   5
    ...
    public void testEquals() {
        ...
        //An DataStructures.tree.avl.AVL of strings (not equal to Integers)
        assertFalse(avl1.equals(new AVL<>(Arrays.asList("0", "1"))));

        avl1 = new AVL<>();
        //An empty DataStructures.tree.avl.AVL of strings
