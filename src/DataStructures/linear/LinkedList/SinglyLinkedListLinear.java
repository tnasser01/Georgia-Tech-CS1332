 ...
 * @version 1.0
 */
public class SinglyLinkedListLinear<T> {
    ...
    */
    ...
    public void addToFront(T data) {
        if (data == null) {
            throw new IllegalArgumentException("Cannot add null value to "
                    + "linked list");
        }
    ...
    public T removeAtIndex(int index) {
        ...
        if (index < 0 || index >= size) {
            throw new IndexOutOfBoundsException("Index of attempted remove "
                    + "cannot be less than zero or greater than size.");
        }
    ...
    public T get(int index) {
        if (index < 0 || index >= size) {
            throw new IndexOutOfBoundsException("Index of attempted get "
                    + "cannot be less than zero and cannot be greater than or "
                    + "equal to list size");
        }
