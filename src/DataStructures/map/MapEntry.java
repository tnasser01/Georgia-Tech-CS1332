...
/**
 * A class representing a DataStructures.map.MapEntry for a DataStructures.map.HashMap.
...
public class MapEntry<K, V> {
    ...
    /**
     * Create a DataStructures.map.MapEntry object with the given key and value.
     *
    ...
    /**
     * Create a DataStructures.map.MapEntry object with the given key, value and next reference.
     *
     * @param key key for this entry
     * @param value value for this entry
