...
/**
 * DataStructures.map.HashMapStudentTests
 *
 * @author Neha Deshpande
 * @version 1.0
 */
public class HashMapStudentTests2 {
    ...
    public void testPutExternalChaining() {
        ...
        putStuffWithChain();
        printStringHashMap();
        System.out.println("Testing to make sure size gets incremented for each DataStructures.map.MapEntry added to chain...");
    ...
    /**
     * Put a baseline of items to the hash DataStructures.map.
     */
